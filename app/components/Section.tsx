  ...
  return (
    <section className="w-full mt-20 md:mt-0 flex items-center justify-between px-32 ">
      <div className="w-1/2 h-1/2">
        ...
        <span className="font-extrabold text-green-600 text-8xl uppercase">
          day
        </span>
        ...
        <div
          ...
          className="text-blue-600  text-7xl uppercase tracking-widest mt-8"
        >
          Smartodo.
        </div>
      ...
      <Image src={img} alt="" className="w-1/2 h-[750px]" />
    </section>
  );
}
